...
# libretro cores
  ...
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET libretro-bsnes-mercury-accuracy"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET libretro-bsnes-mercury-balanced"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET libretro-bsnes-mercury-performance"
  ...
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET libretro-mame"
  ...
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET libretro-pcsx-rearmed"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET libretro-quicknes"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET libretro-snes9x"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET libretro-snes9x-next"
...
# game add-ons
  ...
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET game.libretro.bsnes-mercury-accuracy"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET game.libretro.bsnes-mercury-balanced"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET game.libretro.bsnes-mercury-performance"
  ...
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET game.libretro.mame"
  ...
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET game.libretro.pcsx-rearmed"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET game.libretro.quicknes"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET game.libretro.snes9x"
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET game.libretro.snes9x-next"
